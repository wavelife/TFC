...
#define _MAX_NUMBER_STACKS_IN_QUEUE 5
...
int main( void )
{
    ...
    xQueue = xQueueCreate( _MAX_NUMBER_STACKS_IN_QUEUE, sizeof( long ) );
	...
	if( xQueue != NULL )
	{
		...
		priority 1. */
		xTaskCreate( vSenderTask, "Sender1", 240, ( void * ) 150, 2, NULL );
		xTaskCreate( vSenderTask, "Sender2", 240, ( void * ) 250, 2, NULL );
